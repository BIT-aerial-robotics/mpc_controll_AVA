...
cp -f acado_auxiliary_functions.c acado_integrator.c acado_qpoases_interface.cpp acado_qpoases_interface.hpp acado_solver.c acado_solver_mex.c ~/catkin_ws/src/mpc_controller/lib
